...
public class AdminApproveAdapter extends RecyclerView.Adapter<AdminApproveAdapter.ViewHolder> {
    ...
    public AdminApproveAdapter(List<EventInfo> dataset) {
        mDataset = dataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public AdminApproveAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.organised_event_row, parent, false);
        Log.d("InTheLoop", "Adapter, onCreateViewHolder");

        return new AdminApproveAdapter.ViewHolder(v);
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(AdminApproveAdapter.ViewHolder holder, int position) {
